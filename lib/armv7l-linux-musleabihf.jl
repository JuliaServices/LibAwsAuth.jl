...
function Base.getproperty(x::__JL_Ctag_124, f::Symbol)
    r = Ref{__JL_Ctag_124}(x)
    ptr = Base.unsafe_convert(Ptr{__JL_Ctag_124}, r)
    fptr = getproperty(ptr, f)
    GC.@preserve r unsafe_load(fptr)
end

function Base.setproperty!(x::Ptr{__JL_Ctag_124}, f::Symbol, v)
...
function Base.getproperty(x::Ptr{aws_signing_config_aws}, f::Symbol)
    ...
    f === :flags && return Ptr{__JL_Ctag_124}(x + 140)
